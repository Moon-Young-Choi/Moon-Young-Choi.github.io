...
const routes = ["quant-platform", "pwr-scan", "open-source-intelligence", "eventedge-derivatives", "triangular-arbitrage-detector", "bayesian-ad-targeting"];

test("all six projects share the compact paper contract", async () => {
...
test("paper pages retain only numeric or observed-result tables", async () => {
  const counts = { "quant-platform": 0, "pwr-scan": 0, "open-source-intelligence": 1, "eventedge-derivatives": 0, "triangular-arbitrage-detector": 0, "bayesian-ad-targeting": 3 };
